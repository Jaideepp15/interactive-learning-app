...
const studentsProgress = [
  { name: "Alice", progress: 85, subtopics: ["Algebra", "Calculus", "Geometry"] },
  { name: "Bob", progress: 72, subtopics: ["Trigonometry", "Statistics", "Algebra"] },
  { name: "Charlie", progress: 90, subtopics: ["Probability", "Functions", "Matrices"] },
  { name: "David", progress: 60, subtopics: ["Linear Equations", "Graphs", "Vectors"] },
  { name: "Eve", progress: 78, subtopics: ["Sequences", "Logarithms", "Integration"] },
];
    ...
    <div className="min-h-screen flex flex-col items-center bg-white text-zinc-800 p-8">
      ...
      <div className="w-64 h-64 flex items-center justify-center relative mb-8">
        <ResponsiveContainer width="100%" height="100%">
          <PieChart>
            <Pie
              data={[{ name: "Progress", value: averageProgress }, { name: "Remaining", value: 100 - averageProgress }]}
              cx="50%"
              cy="50%"
              innerRadius={70}
              outerRadius={90}
      ...
      <div className="w-full">
        ...
        <div className="flex flex-col gap-2 w-full">
          {studentsProgress.map((student) => (
            <div key={student.name} className="w-full">
              <button
                ...
                <div className="mt-2 p-6 bg-gray-100 rounded-md shadow-md w-full">
                  <div className="w-40 h-40 mx-auto flex items-center justify-center relative">
                    <ResponsiveContainer width="100%" height="100%">
                      <PieChart>
                        <Pie
                          data={[{ name: "Progress", value: student.progress }, { name: "Remaining", value: 100 - student.progress }]}
                          cx="50%"
                          cy="50%"
                          innerRadius={50}
                          outerRadius={70}
                    ...
                    <div className="absolute text-lg font-bold text-zinc-800">{student.progress}%</div>
                  </div>
