...
const students = [
  ...
  { id: "5", name: "Sophia Jones" },
  { id: "6", name: "Mason Davis" },
  { id: "7", name: "Ava Miller" },
  { id: "8", name: "Elijah Wilson" },
]
...
export default function TeacherFeedback() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!selectedStudent || !feedbackText.trim() || rating === 0) {
      alert("Please select a student and provide both feedback text and a rating.")
      return
    }
      ...
      {submitted ? (
        <div className="bg-green-50 p-6 rounded-lg border border-green-200 text-center">
          ...
          <p className="text-gray-600 mb-6">
            Your feedback has been sent to {students.find((s) => s.id === selectedStudent)?.name}.
          </p>
          <button
            onClick={resetForm}
