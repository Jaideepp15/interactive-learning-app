...
function Login() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Store the JWT token in localStorage (or use cookies)
      localStorage.setItem("token", token);

      // After storing the token, redirect the user to the learning page
  ...
  return (
    <div className="flex min-h-full flex-1 flex-col justify-center px- py-12 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-sm flex flex-col items-center">
        ...
        <p className="text-md text-zinc-400 mt-2 ">Enter your detials to continue your journey</p>
      </div>
